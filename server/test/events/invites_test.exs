defmodule Events.InvitesTest do
  ...
  describe "invites" do
    ...
    @valid_attrs %{email: "some email", resp: "some resp"}
    @update_attrs %{email: "some updated email", resp: "some updated resp"}
    @invalid_attrs %{email: nil, resp: nil}
    ...
    test "update_invite/2 with valid data updates the invite" do
      ...
      assert invite.resp == "some updated resp"
    end
